...
plot(ETH0)
#plot(ETH_dem, add = T)
plot(ETH_dem, col = socolor, add = TRUE, legend = FALSE,
...
plot(pts_eth2, col = "red", pch = 18, add = T)
plot(ETH_Addis, col = "dark grey", add = T)
plot(ETH1, add = T)

legend(x = "bottomright", pch = 20, col = c("blue", "red", "dark grey"),
       legend = c("Exprimental studies", "Survey studies", "Addis Ababa"), bty = "n", pt.cex = 2)
...
# plot(ETH_dem, legend.only=TRUE,  text = 'Elevation (m)')

#OR

# plot(ETH_dem, col = socolor, legend.only=TRUE,
#   label = "masl", legend.args = list(text = "Elevation (m)",
#                       side = 3,
#                       font = 1,
#                       line = 0.5,
