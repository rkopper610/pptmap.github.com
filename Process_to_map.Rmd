...
#list of ETH studdies when qual study is removed.
...
par(mar = c(0, 0, 1, 0 ))
plot(E_Af_No_b, asp=NA, col = "light grey") #plot first to set up boundaries
box()
title(main="PPT Study Site Frequency")

col <- terrain.colors(6)
socolor <-  rev(col) 
plot(msk_DEM, col = socolor,  alpha = 0.75, add = TRUE)
...
legend(x = "topleft", pch = 15, col = "black",
       legend = ("Locations in Studies"), bty = "n", pt.cex = 2)
