...
points(coordinates(UGA_sites),pch = 20, col = "red")
...
#viewmap <-
mapview(E_Af, col.regions = "grey", color = "black", alpha = "0.9" , map.types = "Stamen.Toner") + mapView(KEN_study_sites, col.regions = "red",  color = "red") +
