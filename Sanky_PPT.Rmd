...
#it doesnt work within the ggplot object

#use either of the following and auto complete will display available types--
paletteer_c()
paletteer_d()


x <- paletteer_d("vapoRwave::floralShoppe")
x <- paletteer_d("khroma::soil")
x <- paletteer_d("colorBlindness::PairedColor12Steps")

g1 +  scale_color_gradient(low = x, high = x) + guides(color = guide_legend(), size = guide_legend()) 
